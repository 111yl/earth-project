...
function initGUI(ambientLight, pointLight) {
    ...
    positionFolder.add(pointLight.position, 'x').min(-60).max(60).step(1).name('x坐标');
    positionFolder.add(pointLight.position, 'y').min(-60).max(60).step(1).name('y坐标');
    positionFolder.add(pointLight.position, 'z').min(-60).max(60).step(1).name('z坐标');
